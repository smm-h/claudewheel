...
- **Per-project tag lists**: Each project declares its tags (a file in the project directory or a config key). Tags can also be auto-detected -- e.g., the presence of `.rlsbl/` in a project implies the `rlsbl` tag.
